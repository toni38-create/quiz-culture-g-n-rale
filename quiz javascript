...
/////////////////////////////////////////// TIMER ///////////////////////////////////////////////////
    ...
    function endQuiz() {
        console.log("Quiz terminé !"); // Débogage
        // Logique pour afficher les résultats ou toute autre action de fin de quiz
    }
        ...
        if (answerIndex === correctAnswer) {
            ...
            setTimeout(() => {
                ...
                if (questionIndex + 1 < questions[quizId].length) {
                    ...
                    afficherQuestion(quizId, currentQuestionIndex,timerID);
